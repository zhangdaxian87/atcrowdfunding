...
//	@PreAuthorize("hasAuthority('user:save')")
	...
	public String save(Admin admin) {
		log.info("====>adminHandle.save[/admin/save.html]");
	...
	public String getPageInfo(
		...
		log.info("====>adminHandle.getPageInfo[/admin/get/page.html");
	...
	public String doLogin(@RequestParam("loginAcct") String loginAcct, @RequestParam("userPswd") String userPswd,
			HttpSession session) {
		log.info("====>adminHandle.doLogin[/admin/do/login.html");
...
//	@PostAuthorize("returnObject.data.loginAcct == principal.username")
	...
	public ResultEntity<Admin> getAdminById() {
		log.info("====>adminHandle.getAdminById[/admin/test/post/filter.json");
