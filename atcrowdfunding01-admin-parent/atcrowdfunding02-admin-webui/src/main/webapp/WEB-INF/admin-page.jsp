				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<a style="float: right;" href="admin/to/add/page.html" class="btn btn-primary"><i
							class="glyphicon glyphicon-plus"></i> 新增</a> <br>
						<hr style="clear: both;">
										...
										<c:forEach items="${requestScope.pageInfo.list }" var="admin" varStatus="myStatus">
											<tr>
												...
												<td>
													...
													class="btn btn-success btn-xs"><i class=" glyphicon glyphicon-check"></i></a> <!-- 旧代码 --> <!-- <button type="button" class="btn btn-primary btn-xs">
														<i class=" glyphicon glyphicon-pencil"></i>
													</button> --> <!-- 新代码 --> <a
													href="admin/to/edit/page.html?adminId=${admin.id }&pageNum=${requestScope.pageInfo.pageNum }&keyword=${param.keyword }"
													class="btn btn-primary btn-xs"><i class=" glyphicon glyphicon-pencil"></i></a> <a
								...
								<tfoot>
									<tr>
										<td colspan="6" align="right">
											<div id="page_info" class="pagination" style="float: left; margin: 0px auto">
												<!-- 分页统计信息  -->
												当前第${requestScope.pageInfo.pageNum }页 总${requestScope.pageInfo.pages }页 总${requestScope.pageInfo.total }条记录
											</div>
											<div id="Pagination" class="pagination" style="margin: 0px auto;">
												<!-- 这里显示分页 -->
											</div>
										</td>
									</tr>
